...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: NSDictionary!) -> Bool {
        ...
        let products = [
            ...
            Product(type: Product.deviceTypeTitle, name: "Create Smart Album", year: "Option-Command-N", price: "Press Option-Command-N to create a new smart album. A smart album is a type of album that will automaticly fill itself with photos that it is set to find. For example a Smart Album that is set to find all photos from the year 1998."),
            ...
            Product(type: Product.deviceTypeTitle, name: "Remove a Photo’s Rating", year: "Command-0", price: "Press Command-0 to remove a photos rating."),
            Product(type: Product.deviceTypeTitle, name: "Assign One Star to a Photo", year: "Command-1", price: "Press Command-1 to assign one star to a photo."),
            Product(type: Product.deviceTypeTitle, name: "Assign Two Stars to a Photo", year: "Command-2", price: "Press Command-2 to assign two stars to a photo."),
            Product(type: Product.deviceTypeTitle, name: "Assign Three Stars to a Photo", year: "Command-3", price: "Press Command-3 to assign three stars to a photo."),
            Product(type: Product.deviceTypeTitle, name: "Assign four stars to a hoto", year: "Command-4", price: "Press Command-4 to assign four stars to a photo."),
            Product(type: Product.deviceTypeTitle, name: "Assign Five Stars to a Photo", year: "Command-5", price: "Press Command-5 to assign five stars to a photo."),
            Product(type: Product.deviceTypeTitle, name: "Stop a Slideshow", year: "Escape (esc)", price: "Press the Escape key (esc) during a slideshow to stop it."),
            Product(type: Product.deviceTypeTitle, name: "Pause a Slideshow", year: "Space", price: "Press Space during a slideshow to pause it."),
            Product(type: Product.deviceTypeTitle, name: "Enter Edit View", year: "Command-E", price: "Press Command-E to enter the edit view."),
            Product(type: Product.deviceTypeTitle, name: "Open Crop Tool", year: "C", price: "Press C while in the edit view to open the crop tool."),
            Product(type: Product.deviceTypeTitle, name: "Remove Red Eye", year: "R", price: "Press R while in the edit view to use the red eye removal tool."),
